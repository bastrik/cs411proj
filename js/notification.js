...
function notification(element, seen, stringText){
    var comment = "";
    if(element.commentlink!=null){
        comment = "&"+element.commentlink;
    }
    return '<li><a class="notification '+seen+'" href="/p/'+element.link+comment+'" data-note="'+element.notification_id+'"><b>'+element.username+" </b>"+stringText+'#'+element.link+'<br><span class="note-time">'+element.created+'</span></a></li>';
