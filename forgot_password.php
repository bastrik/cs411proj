...
<!--        <h4 id="message">Unfortunately due to Email issues, this feature is unavailable</h4>-->
        <h4 id="message">Please enter your email address to reset.</h4>
        <form id="pass-reset" class="form-horizontal margintop">
            ...
            <div class="form-group margintop">
                <div class="col-sm-12">
                    ...
                    <a href="forgot_email.php" style="margin-left: 10px">Forgot your Email?</a>
                </div>
            </div>
        </form>
    </div>
